...
from core.models import Categoria, Editora, Autor, ItensCompra, Livro, Compra, ItensCompra
...
class LivroDetailSerializer(ModelSerializer):
    categoria = CharField(source="categoria.descrição")
...
class ItensCompraSerializer(ModelSerializer):
    ...
    def get_total(self, instance):
        return instance.quantidade * instance.livro.preço
